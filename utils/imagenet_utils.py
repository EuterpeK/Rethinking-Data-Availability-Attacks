...
def get_whole_loader(dataset, batch_size, root='./data', train=True, 
    ...
    if not clean:
        ...
        target_set = PoisonedDataset(target_set, raw_noise, fitr=lp_fitr)
    else:
        # lp_fitr   = None if fitr is None else get_filter(fitr)
        # target_set = CleanDataset(target_set, fitr=lp_fitr)
        pass
